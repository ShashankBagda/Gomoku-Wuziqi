...
/**
 * Test for SurrenderWaitingValidateChain
 *
 * @author Claude
 * @version 1.0
 */
class SurrenderWaitingValidateChainTest {

    private SurrenderWaitingValidateChain chain;
    private GameDocument game;

    @BeforeEach
    void setUp() {
        chain = new SurrenderWaitingValidateChain();
