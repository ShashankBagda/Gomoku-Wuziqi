...
/**
 * Service Generation Plugin
 * Generates service interface and implementation classes with CRUD operations using DTO
 *
 * @author Goody
...
public class ServiceGeneratorPlugin extends PluginAdapter {
    ...
    private void addServiceInterfaceMethods(Interface serviceInterface, FullyQualifiedJavaType dtoType,
        ...
        save.setReturnType(new FullyQualifiedJavaType("Long"));
        ...
        save.addJavaDocLine(" * @return primary key id of saved entity, null if failed");
        save.addJavaDocLine(" */");
    ...
    private TopLevelClass generateServiceImplementation(IntrospectedTable introspectedTable) {
        ...
        // Add imports
        serviceImpl.addImportedType(new FullyQualifiedJavaType("com.goody.nus.se.gomoku.common.util.UidGeneratorUtil"));
        ...
        serviceImpl.addImportedType(new FullyQualifiedJavaType("java.time.LocalDateTime"));
    ...
    private void addServiceImplementationMethods(TopLevelClass serviceImpl, FullyQualifiedJavaType dtoType,
        ...
        save.addBodyLine("    return null;");
        save.addBodyLine("}");
        save.addBodyLine("");
        save.addBodyLine("if (dto.getId() == null) {");
        save.addBodyLine("    dto.setId(UidGeneratorUtil.generateUid());");
        save.addBodyLine("}");
        save.addBodyLine("");
        save.addBodyLine(entityClassName + " entity = dto.toEntity();");
        save.addBodyLine("int result = " + mapperFieldName + ".insertSelective(entity);");
        save.addBodyLine("return result > 0 ? entity.getId() : null;");
        ...
        saveBatch.addBodyLine("        .peek(dto -> {");
        saveBatch.addBodyLine("            if (dto.getId() == null) {");
        saveBatch.addBodyLine("                dto.setId(UidGeneratorUtil.generateUid());");
        saveBatch.addBodyLine("            }");
        saveBatch.addBodyLine("            if (dto.getCreatedAt() == null) {");
        saveBatch.addBodyLine("                dto.setCreatedAt(LocalDateTime.now());");
        saveBatch.addBodyLine("            }");
        saveBatch.addBodyLine("            if (dto.getUpdatedAt() == null) {");
        saveBatch.addBodyLine("                dto.setUpdatedAt(LocalDateTime.now());");
        saveBatch.addBodyLine("            }");
        saveBatch.addBodyLine("        })");
        ...
        update.addBodyLine("return " + mapperFieldName + ".updateByPrimaryKeySelective(entity);");
