...
import com.goody.nus.se.gomoku.common.valuechecker.util.CommonUtils;
import com.goody.nus.se.gomoku.common.valuechecker.util.SeplUtil;
...
public class ValueCheckerAspect {
    ...
    /** cut point */
    @Pointcut("@annotation(com.goody.nus.se.gomoku.common.valuechecker.ValueCheckers)")
    ...
    private void valueCheck(ValueCheckers.ValueChecker checker, ProceedingJoinPoint point) throws InvocationTargetException, IllegalAccessException {
        try {
            ...
            LOGGER.error("method invoke BizException", e);
            throw e;
