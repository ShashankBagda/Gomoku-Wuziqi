...
git log --numstat --pretty=format:"commit:%H|author:%an|email:%ae|date:%ad" --date=iso > gitlog_numstat.txt
...
- **Directory analysis** showing code distribution across different parts of the project
- **Comprehensive visualizations**:
  - Code distribution by directory (pie chart)
  - Commits per contributor (bar chart)
  - Net code contribution (bar chart)
  - Directory contributions by author (stacked bar)
  - Directory activity - added vs deleted (grouped bar)
